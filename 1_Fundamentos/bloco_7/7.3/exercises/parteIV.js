...
assert.notDeepStrictEqual(myFizzBuzz(15), 15); // Se não é, (15 % 15) !== 0), oposto do resultado.

// 4.5 Faça uma chamada com um parâmetro que não é um número e verifique se o retorno é o esperado
assert.strictEqual(myFizzBuzz('Não é número'),false);